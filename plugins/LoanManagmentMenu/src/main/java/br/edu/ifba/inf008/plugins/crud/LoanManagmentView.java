...
public class LoanManagmentView {
    ...
    public static Node create() {
        ...
        searchBtn.setOnAction(event -> {
            ...
            List<Loan> loans = LoanManagmentMenu.getInstance().getLoanService().searchLoansByUserName(nameField.getText().trim());
            resultsTable.setItems(FXCollections.observableArrayList(loans));

        });

        resultsTable.getStylesheets().add(LoanManagmentView.class.getResource("/CSS/dark-table.css").toExternalForm());
